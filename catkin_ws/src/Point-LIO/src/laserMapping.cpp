...
{
    odomAftMapped.header.frame_id = "base";
    ...
    br.sendTransform( tf::StampedTransform( transform, odomAftMapped.header.stamp, "rslidar", "base") );
}
...
void publish_path(const ros::Publisher pubPath)
{
    ...
    msg_body_pose.header.frame_id = "rslidar";
    static int jjj = 0;
    jjj++;
