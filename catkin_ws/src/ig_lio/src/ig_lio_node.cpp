...
ros::Publisher pose_with_covariance_pub;
...
void Process() {
  ...
  odom_msg.header.frame_id = "odom"; //map
  ...
  // Convert to PoseWithCovarianceStamped message
  geometry_msgs::PoseWithCovarianceStamped pose_with_covariance_msg;
  pose_with_covariance_msg.header.frame_id = "odom"; //map
  pose_with_covariance_msg.header.stamp = ros::Time::now();
  pose_with_covariance_msg.header = odom_msg.header;
  pose_with_covariance_msg.pose = odom_msg.pose;
...
int main(int argc, char** argv) {
  ...
  pose_with_covariance_pub = nh.advertise<geometry_msgs::PoseWithCovarianceStamped>("/lio_pose", 10000);
  current_scan_pub =
